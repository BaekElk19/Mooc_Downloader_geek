### 				基于Python 爬虫的慕课视频下载*（破解限速）*

##### 1.  项目简介：

- 项目环境为 Windows10,  Python3，原作者为pyjun,免费版限速1M/s,付费可提速。因此在原作者分享的源码上修改了下载参数。
- 感谢原作者提供的[源码](https://github.com/PyJun/Mooc_Downloader)！！
...
- 用户可以直接下载 dist下的 [Setup-Mooc-3.4.0.exe](https://github.com/BaekElk19/Mooc_Downloader_geek/blob/master/dist/Mooc-3.4.2.exe)  安装即可使用
